...
export const en: Dictionary = {
  ...
  "list.createButton": "Create",
  "list.newListPlaceholder": "Enter list name",
  ...
  "settings.tabDiscordWebhooks": "Discord Webhooks",
  "settings.descDiscordWebhooks": "Discord-compatible webhook notifications",
  "settings.discordWebhooks.title": "Discord-compatible Webhook Notifications",
  "settings.discordWebhooks.description": "Forward notifications to a Discord-compatible webhook URL. You can toggle each notification type on/off.",
  "settings.discordWebhooks.add": "Add webhook",
  "settings.discordWebhooks.addTitle": "Add Webhook",
  "settings.discordWebhooks.editTitle": "Edit Webhook",
  "settings.discordWebhooks.name": "Display name",
  "settings.discordWebhooks.url": "Webhook URL",
  "settings.discordWebhooks.urlPlaceholder": "https://discord.com/api/webhooks/.../...",
  "settings.discordWebhooks.urlEditHint": "Only fill this in if you want to change the URL. Leave empty to keep it.",
  "settings.discordWebhooks.enabled": "Enabled",
  "settings.discordWebhooks.disabled": "Disabled",
  "settings.discordWebhooks.empty": "No webhooks registered",
  "settings.discordWebhooks.test": "Send test",
  "settings.discordWebhooks.testSuccess": "Test delivery succeeded",
  "settings.discordWebhooks.testFailure": "Test delivery failed",
  "settings.discordWebhooks.edit": "Edit",
  "settings.discordWebhooks.delete": "Delete",
  "settings.discordWebhooks.deleteConfirm": "Delete this webhook?",
  "settings.discordWebhooks.lastError": "Last error",
  "settings.discordWebhooks.notifyTitle": "Notification types",
  "settings.discordWebhooks.notify.mention": "Mention",
  "settings.discordWebhooks.notify.direct": "Direct",
  "settings.discordWebhooks.notify.quote": "Quote",
  "settings.discordWebhooks.notify.reaction": "Reaction",
  "settings.discordWebhooks.notify.renote": "Renote",
  "settings.discordWebhooks.notify.follow": "Follow",
  "settings.discordWebhooks.notify.followRequest": "Follow request",
  ...
  "admin.descAnnouncements": "Create and manage user announcements",
  ...
  "settings.tabDeletion": "Delete Account",
  "settings.descDeletion": "Schedule or cancel account deletion",
  "deletion.title": "Delete Account",
  "deletion.description":
    "Deleting your account will permanently remove all your data after a 30-day grace period. You can cancel during this period.",
  "deletion.password": "Current password",
  "deletion.request": "Schedule account deletion",
  "deletion.confirm":
    "Are you sure you want to delete your account? All data will be permanently removed after 30 days.",
  ...
  "deletion.cancelSuccess": "Account deletion has been cancelled",
  "deletion.cancelFailed": "Failed to cancel deletion",
  ...
  "admin.permAnnouncements": "Announcements",
  "admin.permAnnouncementsDesc": "Add, edit and delete announcements",
  ...
  "announcements.fromServer": "Server Announcement",
  "announcements.markAsRead": "Mark as read",
  ...
  "themeCustomizer.bgCard": "Card BG",
  "themeCustomizer.textPrimary": "Text",
  "themeCustomizer.textSecondary": "Secondary Text",
  "themeCustomizer.accent": "Accent",
  "themeCustomizer.accentHover": "Accent Hover",
  "themeCustomizer.accentText": "Accent Text",
  "themeCustomizer.border": "Border",
  "themeCustomizer.reblog": "Reblog",
  "themeCustomizer.favourite": "Favourite",
  "themeCustomizer.categoryBackground": "Background",
  "themeCustomizer.categoryText": "Text",
  "themeCustomizer.categoryAccent": "Accent",
  "themeCustomizer.categorySemantic": "Semantic",
  "themeCustomizer.resetToPreset": "Reset to Preset",
  "themeCustomizer.saveToServer": "Save to Server",
  "themeCustomizer.saved": "Theme saved!",
  "themeCustomizer.exportJson": "Export JSON",
  "themeCustomizer.exportCss": "Export CSS",
  "themeCustomizer.import": "Import",
  "themeCustomizer.importHint": "Paste JSON or CSS, or choose a file",
  "themeCustomizer.importError": "Invalid theme format",
  "themeCustomizer.preview": "Preview",
  "themeCustomizer.sampleText": "This is a sample note to preview your theme.",
  "themeCustomizer.themeName": "Theme Name",
  "themeCustomizer.themeNamePlaceholder": "My Custom Theme",
};
